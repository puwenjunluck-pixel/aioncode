...
<!-- PLATFORM:antigravity -->
   - 用 Browser Agent 打开 → 截图关键状态 → 描述观察到的布局 / 组件 / 用户流。视觉理解优于读源码。
<!-- /PLATFORM:antigravity -->
<!-- PLATFORM:claude -->
...
<!-- /PLATFORM:claude -->
<!-- PLATFORM:antigravity -->
**Browser Agent 可视伴侣**:若需要展示 mockup / 对比竞品 / 看原型,提议"我用 Browser Agent 打开相关页面截图评估,要开吗?(需要打开本地 URL,token 消耗较多)"
<!-- /PLATFORM:antigravity -->
...
<!-- /PLATFORM:claude -->
<!-- PLATFORM:antigravity -->
**Browser Agent 协作**:若 Phase 2 启用了 Browser Agent,需要对比参考产品时,打开对应页面截图捕获布局模式作为证据。
<!-- /PLATFORM:antigravity -->
